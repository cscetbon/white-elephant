 ...
 */
package com.linkedin.whiteelephant.mapreduce;
...
// patched version of AvroMultipleOutputs which actually works

public class MyAvroMultipleOutputs{
   ...
   */
  private static final String COUNTERS_GROUP = MyAvroMultipleOutputs.class.getName();
 ...
 /**
   ...
   */
  public MyAvroMultipleOutputs(
      TaskInputOutputContext<?, ?, ?, ?> context) {
    this.context = context;
    namedOutputs = Collections.unmodifiableSet(
      new HashSet<String>(MyAvroMultipleOutputs.getNamedOutputsList(context)));
